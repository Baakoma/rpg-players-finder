    ...
    <div>
        <div class="modal-card">
            <header class="modal-card-head has-background-primary">
                <p class="modal-card-title has-text-white">Edit type</p>
            </header>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            update() {
                this.fetching = true;
                this.$http.put(`/types/${this.id}`, this.typeData)
                    .then(() => {
                        this.$emit('updated');
                        this.$parent.close();
                    })
                    .then(() => {
                        Messenger.success('Type updated successfully');
                    })
                    .catch((error) => {
